...
\caption{The same eight configurations, full-range ROC. Legend values are area under the curve. Every series sits near the corner over the full axis, which is why Figure~\ref{fig:roczoom} restricts to the low-false-positive region instead.}
\label{fig:roc}
\end{figure*}
...
\caption{Confusion matrices for the five models Table~\ref{tab:allmodels} reports on directly, both corpora, cell counts and row percentages. NB/BoW misses 53 of 3519 human and 233 of 3479 machine DAIGT V2 documents, and 634 of 5377 human and 747 of 5355 machine HC3 documents. DeBERTa's HC3 errors fall to 17 human and 13 machine, out of 30 total.}
\label{fig:confusion}
\end{figure*}

...
% Float placement. IEEEtran's defaults are conservative, so a full-width
% figure* is often the only thing LaTeX will put on a page and the rest of the
% column is left blank. These raise how much of a page a float may occupy and
% tighten the skips around one, which removes the large vertical gaps.
...
\author{\IEEEauthorblockN{Niloy Paul} %1\textsuperscript{st}
\IEEEauthorblockA{\textit{Department of Computer Science} \\
\textit{American International University-Bangladesh}\\
Dhaka, Bangladesh \\
23-51773-2@student.aiub.edu}
\and
\IEEEauthorblockN{Arnob Sarker Supta} %2\textsuperscript{nd}
\IEEEauthorblockA{\textit{Department of Computer Science} \\
\textit{American International University-Bangladesh}\\
Dhaka, Bangladesh \\
23-52080-2@student.aiub.edu}
\linebreakand
\IEEEauthorblockN{Nazmus Sakib} %3\textsuperscript{rd}
\IEEEauthorblockA{\textit{Department of Computer Science} \\
\textit{American International University-Bangladesh}\\
Dhaka, Bangladesh \\
